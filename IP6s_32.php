		...
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<!--	<h3>CHƯƠNG TRÌNH KHUYẾN MẠI ĐẶC BIỆT ĐẾN 22/10:KHÁCH HÀNG CHỌN 1 TRONG 2 KHUYẾN MẠI SAU:</h3>
					...
					<ul type="disc">
						...
						<li>Trả góp 0% qua thẻ tín dụng + PMH Phụ Kiện 150,000đ + Bao da/Ốp lưng iPhone chính hãng
						</li>
					</ul>
					<!--<div class="clear"></div>
					<h2>KM2:</h2>
		...
		<div class="col-xs-12 tab_dt" style="margin-top: 10px">
			...
			<div class="tab-content" style="margin-top: 20px">
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/ipX.png">
							<h5>iPhone Xs Max 64GB</h5>
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							...
							<h5>iPhone 11 128GB</h5>
							<strong>15.490.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/ip12.jpg">
							<h5>iPhone 12 128GB</h5>
					...
					<ul>
						...
						<li>
							<a href="#"><img src="images/ip6s_2.jpg" class="img-responsive h_1">
								<h3>Dòng iPhone 7 Plus lập kỉ lục bán hàng mới trong Quý 4 2021</h3>
							</a>							
						</li>
						<li>
