		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<figure class="content_figure">
					...
					<div class="promotion">
						<span> Được bốc thăm nhận phiếu quà tặng lên đến 8.000.000 ₫</span>
					</div>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/samsungs20.png" class="img-responsive">
				<h3 style="margin-top: 20px">Samsung S20</h3>
				...
				<figure class="content_figure">
					...
					<strong>13.400.000 ₫</strong>
					<div class="promotion">
						<span> Tặng ngay phiếu giảm giá lên đến 50% khi mua sản phẩm của Samsung</span>
					</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<figure class="content_figure">
					...
					<div class="promotion">
						<span>Tặng ngay Loa Bluetooth và Tai nghe không dây</span>
					</div>
