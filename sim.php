	...
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<h3>Sim Mobifone</h3>
				<strong class="tien">Liên hệ người bán</strong>
				<div class="coupon">
					<span>Inbox</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Sim Mobifone</span>
					<div class="promotion">
						<span> Hỗ trợ làm nanosim tại chỗ khi mua đt ở shop</span>
					</div>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/viettel.png" class="img-responsive">
				<h3 style="margin-top: 20px">Sim Viettel</h3>
				<strong class="tien">Liên hệ người bán</strong>
				<div class="coupon">
					<span>Inbox</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Sim Viettel</span>
					<div class="promotion">
						<span> Hỗ trợ làm nanosim tại chỗ khi mua đt ở shop</span>
					</div>
				</figure>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/vina.png" class="img-responsive">
				<h3 style="margin-top: 20px">Sim Vina</h3>
				<strong class="tien">Liên hệ người bán</strong>
				<div class="coupon">
					<span>Inbox</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Sim Vina</span>
					<div class="promotion">
						<span> Hỗ trợ làm nanosim tại chỗ khi mua đt ở shop</span>
					</div>
				</figure>
