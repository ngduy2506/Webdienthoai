...
<div class="container bg_content" style="margin-top: 35px">
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/xsmax.png" >
				<h3>iPhone Xs Max 64GB</h3>
				<strong class="tien">10.500.000 ₫</strong>
				<div class="coupon">
					<span>BH 9T</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">iPhone Xs Max 64GB</span>
					<strong>10.500.000₫</strong>
					<div class="promotion">
						<span>Ngoại hình xước dăm và Không kèm phụ kiện</span>
					</div>
					<span>Màn hình: OLED6.5"Super Retina</span>
					<span>HĐH: iOS 14.0</span>
					<span>CPU: Apple A12</span>
					<span>RAM: 4 GB</span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/samsungs10.png" class="img-responsive">
				<h3 style="margin-top: 20px">Samsung S10</h3>
				<strong class="tien">8.290.000 ₫</strong>
				<div class="coupon">
					<span>BH 9T</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Samsung S10</span>
					<strong>8.290.000 ₫</strong>
					<div class="promotion">
						<span>Hết Hàng</span>
					<span>Màn hình: Dynamic AMOLED6.4"Quad HD+ (2K+)</span>
					<span>HĐH: Android 9</span>
					<span>CPU: Exynos 9820</span>
					<span>RAM: 8 GB,ROM: 128 GB</span>
					<span>Camera: 3 camera 12 MP, Selfie: 2 camera 10 MP và 8MP</span>
					<span>PIN: 4100 mAh, SIM: 2 SIM</span>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/oppoa74.png" class="img-responsive">
				<h3 style="margin-top: 20px">Oppo A74</h3>
				<strong class="tien">6.220.000 ₫</strong>
				<div class="coupon">
					<span>BH 9T</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Oppo A74</span>
					<strong>6.220.000 ₫</strong>
					<div class="promotion">
						<span>Đã thay pin còn lại đẹp keng</span>
					</div>	
					<span>Màn hình: AMOLED6.43"Full HD+</span>
					<span>HĐH: Android 11</span>
					<span>CPU: Snapdragon 662</span>
					<span>RAM: 8 GB,ROM: 128GB</span>
					<span>Camera: 3 camera 12 MP, Selfie: 12 MP</span>
					<span>PIN: 5000 mAh,33 W</span>
				</figure>
			</a>
		</div>
	</div>
