...
<div class="container bg_content" style="margin-top: 35px">
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/oppoa9.png" >
				<h3>Oppo A9</h3>
				<strong class="tien">2.490.000 ₫</strong>
				<div class="coupon">
					<span>Trả góp 0%</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Oppo A9</span>
					...
					<span>CPU: Snapdragon 665</span>
					<span>RAM: 8 GB, ROM: 128 GB</span>
					<span>Camera: Chính 48 MP & Phụ 8 MP, 2 MP, 2 MP, Selfie: 16 MP</span>
					<span>PIN: 5000 mAh,2 Nano SIM Hỗ trợ 4G</span>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/oppoa15.png" class="img-responsive">
				<h3 style="margin-top: 20px">Oppo A15</h3>
				<strong class="tien">3.490.000 ₫</strong>
				<figure class="content_figure">
					<span class="slogan">Oppo A15</span>
					<strong>3.490.000₫</strong>
					<span>Màn hình: IPS LCD6.52"HD+</span>
					<span>HĐH: Android 10</span>
					<span>CPU: MediaTek Helio P35</span>
					<span>RAM: 3 GB, ROM: 32 GB</span>
					<span>Camera: chính 13 MP & phụ 2 MP, 2 MP, Selfie: 8 MP</span>
					<span>PIN: 54230 mAh,10 W và SIM: 2 Nano SIM hoặc 1 Nano SIM + 1 eSIM Hỗ trợ 4G</span>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/oppoa94.png" class="img-responsive">
				<h3 style="margin-top: 20px">Oppo A94</h3>
				<strong class="tien">7.490.000 ₫</strong>
				
				<figure class="content_figure">
					<span class="slogan">Oppo A94</span>
					...
					<span>RAM: 8 GB, ROM: 128 GB</span>
					<span>Camera: chính 48 MP & phụ 8 MP, 2 MP, 2 MP, Selfie: 32 MP</span>
					<span>PIN: 4310 mAh,30 W và 2 Nano SIM Hỗ trợ 4G</span>
				</figure>
			</a>
		</div>
	</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<figure class="content_figure">
					...
					<div class="promotion">
						<span>Giảm ngay 500.000đ khi thanh toán trực tuyến</span>
					</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<figure class="content_figure">
					...
					<div class="promotion">
						<span> Nhập mã HPBD17 giảm 10% tối đa 2.500.000đ khi thanh toán quét QRcode qua App của ngân hàng</span>
					</div>
