...
<div class="container bg_content" style="margin-top: 35px">
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/asus2.png" >
				<h3>Asus Max 2</h3>
				<strong class="tien">3.190.000 ₫</strong>
				<div class="coupon">
					<span>Trả góp 0%</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Asus Max 2</span>
					<strong>3.190.000 ₫</strong>
					<div class="promotion">
						<span> Tặng full phụ kiện kèm theo</span>
					</div>
					<span>Màn hình:IPS LCD6.26"HD+</span>
					<span>HĐH: Android 11</span>
					<span>CPU: Snapdragon 632</span>
					<span>RAM: 8 GB,ROM: 128 GB</span>
					<span>Camera: 2 camera 13 MP,2 MP, Selfie: 8 MP</span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/asus3.png" class="img-responsive">
				<h3 style="margin-top: 20px">Asus Rog Phone 3</h3>
				<strong class="tien">19.390.000 ₫</strong>
				<figure class="content_figure">
					<span class="slogan">Asus Rog Phone 3</span>
					<strong>19.390.000 ₫</strong>
					<div class="promotion">
						<span>Tặng full phụ kiện kèm theo</span>
					<span>Màn hình:6.59 inches 	AMOLED</span>
					<span>HĐH: Android 10</span>
					<span>CPU: Snapdragon 865+</span>
					<span>RAM: 12 GB,ROM: 512 GB</span>
					<span>Camera: 13 MP, Selfie: 24 MP</span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<h3 style="margin-top: 20px">Asus Zen Phone 8</h3>
				<strong class="tien">14.990.000 ₫</strong>
				
				<figure class="content_figure">
					<span class="slogan">Asus Zen Phone 8</span>
					<strong>14.990.000 ₫</strong>
					<div class="promotion">
						<span>Tặng full phụ kiện kèm theo</span>
					</div>	
					<span>Màn hình: Super AMOLED5.9"Full HD+</span>
					<span>HĐH: Android 11</span>
					<span>CPU: Snapdragon 888</span>
					<span>RAM: 12 GB,ROM: 256 GB</span>
					<span>Camera: 2 camera 64 MP,12 MP, Selfie: 12 MP</span>
					<span>PIN: 4000 mAh</span>
				</figure>
			</a>
		</div>
