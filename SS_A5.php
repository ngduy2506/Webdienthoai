	...
	<div class="row">
		...
		<div  class="col-lg-5 col-md-5 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					...
					<h3> Gọi <span>0938888485</span> để được tư vấn ( miễn phí cuộc gọi )</h3>
				</div>
		</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Samsung Galaxy A5</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về Samsung Galaxy A5</h2>
				<div class="inform_tt">
					<ul>
						<li>
						...
						<li>
							<a href="#"><img src="images/a5_2.jpg " class="img-responsive h_1">
								<h3>Galaxy A5 nhận bản cập nhật mới, thêm tính năng xóa phông cho camera selfie</h3>
							</a>							
						</li>
						<li>
							<a href="#"><img src="images/a5_3.jpg " class="img-responsive h_1">
								<h3>5 Điều người dùng cần lưu ý để có bức ảnh hoàn hảo cùng Samsung Galaxy A5</h3>
							</a>							
						</li>
						<li>
							<a href="#"><img src="images/a5_4.jpg " class="img-responsive h_1">
								<h3>Đánh giá Galaxy A5 sau 2 tháng: camera xuất sắc trong tầm giá, pin trâu, hiệu năng tốt</h3>
							</a>					
...
<div class="container">
	<div id="fb-root"></div>
	<div class="fb-comments" data-href="https://www.facebook.com/%C4%90eaniphone-107849617650919"></div>
</div>
<div class="container">
