...
<div class="container bg_content" style="margin-top: 35px">
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/cuongluc.png" >
				<h3>Kính cường lực</h3>
				<strong class="tien">150.000 ₫</strong>
				<div class="coupon">
					<span>Tặng</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Kính cường lục</span>
					<strong>150.000 ₫</strong>
					<div class="promotion">
						<span>Khi mua Đt sẽ được tặng kèm</span>
					</div>
					<span>Chống trày,xước</span>
					<span>Chống nước</span>
					<span>Chống vỡ màn hình</span>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/oplung.png" class="img-responsive">
				<h3 style="margin-top: 20px">Ốp lưng</h3>
				<strong class="tien">100.000 ₫</strong>
				<div class="coupon">
					<span>Tặng</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Ốp lưng</span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/dp.png" class="img-responsive">
				<h3 style="margin-top: 20px">Sạc dự phòng</h3>
				<strong class="tien">200.000 ₫</strong>
				<div class="coupon">
					<span>Tặng</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Sạc dự phòng</span>
