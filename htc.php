	...
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<h3>HTC One</h3>
				<strong class="tien">1.190.000 ₫</strong>
				<div class="coupon">
					<span>Trả góp 0%</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">HTC One</span>
					<strong>1.190.000 ₫</strong>
					<div class="promotion">
						<span>Sản Phảm Ngừng Kinh Doanh</span>
					</div>
					<span>Màn hình: 4.7"Full HD</span>
					<span>HĐH: Android 9</span>
					<span>CPU: Snapdragon 632</span>
					<span>RAM: 8 GB,ROM: 128 GB</span>
					<span>Camera:13 MP,2 MP, Selfie: 8 MP</span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/hu13.png" class="img-responsive">
				<h3 style="margin-top: 20px">HTC U13</h3>
				<strong class="tien">7.866.000 ₫</strong>
				<figure class="content_figure">
					<span class="slogan">HTC U13</span>
					<strong>7.866.000 ₫</strong>
					<div class="promotion">
						<span>Sản Phảm Ngừng Kinh Doanh</span>
					<span>Màn hình:6.5"Quad HD (5K)</span>
					<span>HĐH: Android 11</span>
					<span>CPU: Snapdragon 865+</span>
					<span>RAM: 12 GB,ROM: 256 GB</span>
					<span>Camera: 12 MP, Selfie: 24 MP</span>
