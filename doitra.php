...
<div class="container bg_content" style="margin-top: 35px">
	<div class="row content_1">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				...
				<figure class="content_figure">
					...
					<span>Màn hình: LED-backlit IPS LCD5.5"Retina HD</span>
					<span>HĐH: iOS 12.0</span>
					<span>CPU: Apple A10</span>
					<span>RAM: 3 GB</span>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/samsungnote10.png" class="img-responsive">
				<h3 style="margin-top: 20px">Samsung Note 10</h3>
				<strong class="tien">6.590.000 ₫</strong>
				<div class="coupon">
					<span>BH 9T</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Samsung Note 10</span>
					<strong>6.590.000 ₫</strong>
					<div class="promotion">
						<span> Đổi trả Bảo Hành</span>
					</div>
					<span>Màn hình: Dynamic AMOLED6.3"Full HD+</span>
					<span>HĐH: Android 10</span>
					<span>CPU: Exynos 9825</span>
					<span>RAM: 8 GB,ROM: 128 GB</span>
					<span>Camera: 3 camera 12 MP, Selfie: 10 MP</span>
					<span>PIN: 3500 mAh, SIM: 2 SIM</span>
				</figure>
			</a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 content_img">
			<a href="#">
				<img src="images/oppoa93.png" class="img-responsive">
				<h3 style="margin-top: 20px">Oppo A93</h3>
				<strong class="tien">4.490.000 ₫</strong>
				<div class="coupon">
					<span>BH 9T</span>
				</div>
				<figure class="content_figure">
					<span class="slogan">Oppo A93</span>
					...
					<span>CPU: MediaTek Helio P95 GHz</span>
					<span>RAM: 8 GB,ROM: 128 GB</span>
